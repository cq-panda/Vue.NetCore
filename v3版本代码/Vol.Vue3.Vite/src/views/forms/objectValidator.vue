    ...
    <div class="validator">
      <div class="general">
        <div class="v1">
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test1()" long>提交验证test1</el-button>
          </div>
        </div>
        ...
        <div class="v2">
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test2()" long>提交验证test2</el-button>
          </div>
        </div>
        <div class="v3">
          <h2>验证字符长度与数字大小</h2>
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test3()" long>提交验证test3</el-button>
          </div>
        </div>
      </div>
      ...
      <div class="object-model">
        <div class="v4">
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test4()" long>提交验证test4</el-button>
          </div>
        </div>
        ...
        <div class="v5">
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test5()" long>提交验证test5</el-button>
          </div>
        </div>
        ...
        <div class="v6">
          ...
          <div class="btn">
            <el-button type="success" size="small" @click="test6()" long>提交验证test6</el-button>
          </div>
        </div>
      </div>
    </div>
