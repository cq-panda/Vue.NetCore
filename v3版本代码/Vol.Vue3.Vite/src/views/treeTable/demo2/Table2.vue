  ...
  <div style="padding: 12px 15px;">
    ...
    >
      ...
      <div style="text-align: right">
        <el-button type="primary" size="small" @click="clear">清空表</el-button>
        <el-button type="primary" size="small" @click="del">删除行</el-button>
        <el-button type="primary" size="small" @click="add">添加行</el-button>
        <el-button type="primary" size="small" @click="getRows"
          >获取选中的行</el-button
        >
      </div>
    </VolHeader>
