      ...
      <el-tabs type="border-card" style="min-height: 230px; box-shadow: none">
        <el-tab-pane>
          ...
          <div class="header">
            ...
            <div class="btns">
              <el-button type="primary" size="small" plain @click="clear"
                >清空表</el-button
              >
              <el-button type="primary" size="small" plain @click="del"
                >删除行</el-button
              >
              <el-button type="primary" size="small" plain @click="add"
                >添加行</el-button
              >
              <el-button type="primary" size="small" plain @click="getRows"
                >获取选中的行</el-button
              >
            </div>
          </div>
