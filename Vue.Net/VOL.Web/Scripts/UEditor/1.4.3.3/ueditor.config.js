...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'insertimage', 'emotion', 'map', 'pagebreak', 'template', '|',
        ...
        , whitList: {
            ...
            u: [],
            ul: ['class', 'style'],
            video: ['autoplay', 'controls','poster', 'loop', 'preload','source','type', 'src', '_src', '_url', 'height', 'width', 'class', 'style'],            source: ['src','type'],
            iframe: ['src', 'scrolling', 'class', 'height', 'width', 'max-width', 'style', 'max-height', 'align', 'frameborder', 'allowfullscreen']
        }
    };
