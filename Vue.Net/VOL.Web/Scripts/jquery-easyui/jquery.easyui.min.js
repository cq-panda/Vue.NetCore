 ...
 * 1、  function _773(_774, _775, _776) {新增自定义编辑object判断
 * 2、 $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {增加异步请求表格数据后error事件返回信息的处理的
 * 3、fcalculateHeight:{id:'#search_Panel'},增加高度计算
 * 4、calculateWidth:{id:'#search_Panel',totalWidth:1020,totalCol:11},增加宽度计算
 *
 */
...
(function ($) {
    ...
    $.fn.pagination = function (_ca, _cb) {
        ...
        return this.each(function () {
            ...
            if (_cd) {
                ...
                // $.fn.pagination.defaults.layout.push("links");
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showPageInfo: true, showRefresh: true, links: 11, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "links", "refresh", "info"], onSelectPage: function (_d1, _d2) {
...
(function ($) {
    ...
    $.fn.window.defaults = $.extend({}, $.fn.panel.defaults, { zIndex: 9000, draggable: true, resizable: true, shadow: true, modal: false, border: true, inline: false, title: "消息提示", collapsible: true, minimizable: true, maximizable: true, closable: true, closed: false, constrain: false });
})(jQuery);
(function ($) {
    function _2a7(_2a8) {
    ...
    $.fn.dialog.defaults = $.extend({}, $.fn.window.defaults, { title: "消息提示", collapsible: false, minimizable: false, maximizable: false, resizable: false, toolbar: null, buttons: null });
})(jQuery);
(function ($) {
    function _2bc() {
    ...
    function _2c1(_2c2) {
        var opts = $.extend({}, $.messager.defaults, { modal: false, shadow: false, draggable: false, resizable: false, closed: true, style: { left: "", top: "", right: 0, zIndex: $.fn.window.defaults.zIndex++, bottom: -document.body.scrollTop - document.documentElement.scrollTop }, title: "消息提示", width: 250, height: 50, minHeight: 0, showType: "slide", showSpeed: 600, content: _2c2.msg, timeout: 4000 }, _2c2);
    ...
    $.messager = {
        show: function (_2c7) {
            //2017.07.03增加处理提示参数，减少Js每次传递的参数
            var showPar = { title: '消息提示', msg: "", color: "red" };
...
(function ($) {
    ...
    function _68d(_68e) {
        ...
        if (opts.pagination) {
            ...
            _695.pagination({
                total: opts.data ? (opts.data.total || opts.data.length) : 1,//2017.06.28增加，修复不显示分页条
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_696, _697) {
        ...
        function _693(_698, _699, _69a) {
            ...
            if (_69a && opts.rownumbers) {
                ...
                ////20170711增加grid表字段显示
                //td.click(function () {
                //    $.gridMethods.showField(opts.columns[0]);
                //});
                if ($("tr", t).length == 0) {
    ...
    //    function _773(_774, _775, _776) {新增自定义编辑object判断
    function _773(_774, _775, _776) {
        ...
        if (!_776) {
            ...
            tr.find("div.datagrid-editable").each(function () {
                ...
                var _77e = ed.actions.getValue(ed.target, row);
                //新增自定义编辑object判断
                if (typeof _77e == 'object') {
                    returnObj = true;
                }
                if (row[_77c] !== _77e) {
                    row[_77c] = _77e;
    ...
    $.fn.datagrid = function (_7cb, _7cc) {
        ...
        _7cb = _7cb || {};
        //2017.08.04增加：根据屏幕分辨率动态计算grid的高度，grid默认高度为340
        if (_7cb.calculateHeight && _7cb.calculateHeight.id) {
            if (!_7cb.detail) {
                var gridHeight = document.body.clientHeight - $(_7cb.calculateHeight.id).height() - 30;
                if (_7cb.height == 340 && gridHeight < 300) {
                    gridHeight = 300;
                } else {
                    gridHeight = gridHeight + 18;
                }
                _7cb.height = gridHeight;
            } else {
                var realHeight = gridDetailParameters.layElement.window.find(".content").height()
                    - gridDetailParameters.layElement.content.height()
                    - gridDetailParameters.layElement.detailHead.height() - 20;
                if (realHeight > 250) {
                    _7cb.height = realHeight;
                }
            }
        }
        if (_7cb.rownumbers) {
            // _7cb.rownumbers = false;
        }

        //2017.08.04增加：根据屏幕分辨率列宽度动态计算grid的宽度

        if (_7cb.calculateWidth && _7cb.calculateWidth.id) {

            var clientWidth = 0;
            if (!_7cb.detail) {
                clientWidth = document.body.clientWidth - 110 - _7cb.calculateWidth.totalWidth;
            } else {
                clientWidth = gridDetailParameters.layElement.detailHead.width() - 60 - _7cb.calculateWidth.totalWidth;
            }

            var argWidth = Math.ceil((clientWidth + (_7cb.calculateWidth.totalCol < 10 ? 35 : 24)) / _7cb.calculateWidth.totalCol);
            if (argWidth > 0 || _7cb.calculateWidth.totalCol <= 10) {
                //if (argWidth > 0) {
                //    argWidth = Math.ceil((clientWidth) / (_7cb.calculateWidth.totalCol));
                //}
                $.each(_7cb.columns[0], function (index, obj) {
                    if (!obj.hidden && obj.width > 60) {
                        obj.width += argWidth;
                    }
                });
            }
    ...
    var _826 = {
        render: function (_827, _828, _829) {
            ...
            for (var i = 0; i < _838.length; i++) {
                ...
                if (col) {
                    //增加日期格式化转换
                    if (col.datatype && (col.datatype == "DateTime" || col.datatype == "Date") && _83b[_83d]) {
                        _83b[_83d] = _83b[_83d];
                        //if (col.datatype == "DateTime") {
                        //    _83b[_83d] = _83b[_83d].formatTime();
                        //} else {
                        //    _83b[_83d] = _83b[_83d].formatDate();
                        //}
                    }
                    var _83e = _83b[_83d];
        ...
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 24, headerEvents: { mouseover: _6ae(true), mouseout: _6ae(false), click: _6b2, dblclick: _6b7, contextmenu: _6ba }, rowEvents: { mouseover: _6bc(true), mouseout: _6bc(false), click: _6c3, dblclick: _6cd, contextmenu: _6d1 }, rowStyler: function (_86c, _86d) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _86e, dataType: "json", success: function (data) {
                    ...
                    helper && helper.error(XMLHttpRequest);
                }
            });
...
//2017.06.29增加编辑功能，使用$('#table').initiEidt();进行初始化
(function ($) {
    ...
    //function endEditing(gridtable) {
    //    if (editIndex == undefined) { return true }
    //    if (gridtable.datagrid('validateRow', editIndex)) {
    //        gridtable.datagrid('endEdit', editIndex);
    //        editIndex = undefined;
    //        return true;
    //    }
    //    return false;
    //}
    //初始化编辑功能
    //http://blog.sina.com.cn/s/blog_7b87efa50101bckk.html自定义编辑器
    //http://www.jeasyui.net/tutorial/37.html
    //https://blog.csdn.net/tianlincao/article/details/7494467
    $.fn.extend({
        initiEidt: function () {
            var $this = this;
            var gridUrl = this.datagrid("options").url;
            ...
            this.datagrid("options").url = gridUrl;
        }
    });
