<template>
  <div class="vol-tabs">
    <Tabs>
      ...
      <TabPane label="一对多3"
               icon="ios-apps">一对多3(此处可以写任意内容)</TabPane>
      <TabPane label="一对多4"
               icon="ios-apps">一对多4(此处可以写任意内容)</TabPane>
      <TabPane label="一对多5"
               icon="ios-apps">一对多5(此处可以写任意内容)</TabPane>
    </Tabs>
  </div>
</template>
<script>
    ...
    return {
      ...
      tableColumns1: [
        { field: "id", title: "主键ID", type: "int", width: 80, hidden: true },
        {
          ...
          sortable: true, edit: { type: "text" } //keep:true始终开启编辑，false双击才能编辑
        },
        { field: "imageUrl", title: "封面图片", type: "img", width: 170 },
        {
          field: "dailyRecommend", title: "内容推荐", type: "sbyte",
          bind: { key: "dr", data: [] }, edit: { type: "switch" },
        ...
        },
        {
          ...
          width: 150, readonly: true, sortable: true, edit: { type: "datetime" }
        }
      ],
      //从表2
