  ...
  <div class="doc-content">
    ...
    font-size: 26px;">QQ群:45221949</a>
      ...
      <ul style="font-family:微软雅黑;font-size:13px;white-space:normal;box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:5px 30px;">
        ...
        <li style="padding-left: 26px;list-style: none;">
          <span style="color:#E56600;">如从没执行过npm install命令，使用cmd命令切换至前端Vue项目../VOL.Vue路径下,执行npm install命令</span>
        </li>
        <li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
        ...
        <li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
          <span style="line-height:3;font-size:14px;color:red;">
            <span style="font-size:16px;">1、登陆页面一直登陆中不跳转：数据库连接没配置好,在appsettings.json中重新配置，或者可以调试查看具体错误，后台调试方法见文档：【后台开发】->【调试】</span>
          </span>
        </li>
        <li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
          <span style="line-height:3;font-size:14px;color:red;">
      ...
      <ul style="   padding-left: 24px;">
        ...
        <li>
          ...
          <p style="font-size:16px;line-height:3;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2、执行前端发布：../vol.vue/目录下双击build.bat运行，发布完成后的项目在dist文件夹里</p>
        </li>
        <li>
