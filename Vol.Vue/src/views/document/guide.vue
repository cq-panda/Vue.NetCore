<template>
  <div id="cnblogs_post_body">
   ...
   <h2 style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;padding:2px 20px;border-radius:6px;color:#EBEBEB;font-family:&quot;background:#00BCD4;font-size:20px;line-height:37px;white-space:normal;margin:18px 0px !important;">
	<span style="display:none;"></span><span style="color:#666666;">开发及依赖环境</span>
</h2>
<p>
	<span style="color:#666666;"><span style="display:none;"></span><span style="display:none;"></span><strong><span style="color:#000000;">&nbsp; &nbsp; &nbsp; <span style="color:#E56600;">&nbsp;如果需要后台开发，请将VS2019更新至最新版本</span></span></strong><span style="display:none;"></span><span style="display:none;"></span></span>
</p>
<p>
...
<ul style="font-family:微软雅黑;font-size:13px;white-space:normal;padding-left: 30px;">
	<li>
		<span style="line-height:3;font-size:16px;">后台：VS2019、.NetCore3.1 、EFCore3.1、JWT、Dapper、Autofac、SqlServer/MySql、Redis(可选)</span>
	</li>
	<li>
...
<ul style="font-family:微软雅黑;font-size:13px;white-space:normal;box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:5px 30px;">
  <li><span style="color:#E56600;">运行前先看后台appsettings.josn配置属性说明</span></li>
	<li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
		<span style="line-height:3;font-size:16px;">启动后台项目：后端项目路径&nbsp; ../VOL.WebApi，找到dev_run.bat命令点击启动。后台启动</span><span style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;line-height:3;font-size:14px;"><span style="font-size:16px;">默认端口是9991。</span></span>
	</li>
  <li> <span style="color:#E56600;">如从没执行过npm install命令，使用cmd命令切换至前端Vue项目../VOL.Vue路径下,执行npm install命令</span></li>
	<li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
		<span style="line-height:3;font-size:16px;">启动前端项目：前端Vue项目路径 ../VOL.Vue ，&nbsp;<span style="font-family:微软雅黑;font-size:16px;white-space:normal;">找到</span><span style="font-family:微软雅黑;font-size:16px;white-space:normal;"><span style="font-family:微软雅黑;font-size:16px;white-space:normal;">run.bat</span>命令点击启动</span>。</span>
	</li>
	<li style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:0px;">
		<span style="line-height:3;font-size:14px;"><span style="font-size:16px;">输入htt</span><span style="font-size:16px;">p://localhost:8080访问（本地超级管理员帐号：admin 密码:123456）</span></span>
	</li>
</ul>
<p>
	<span><span style="font-size:16px;"><span style="display:none;"></span><br />
</span></span>
</p>
<h2 style="padding-left: 24px;white-space:normal;box-sizing:border-box;-webkit-tap-highlight-color:transparent;padding:2px 20px;border-radius:6px;font-family:&quot;background:#00BCD4;font-size:20px;line-height:37px;margin:18px 0px !important;">
	<span><span style="color:#666666;">项目开发</span><span style="display:none;"></span></span>
</h2>
<p>
</p>
<ul style="   padding-left: 24px;">
	<li>
		<span style="font-size:16px;line-height:3;"><span style="display:none;"></span>使用代码生成器自动生成前端、后台代码【代码生成介绍】</span>
	</li>
	<li>
		<span style="font-size:16px;line-height:3;">如果生成的代码满足不了业务，可使用扩展代码进行业务编写，扩展业务编写参照【组件Api】使用，重点是【ViewGird组件】使用</span>
	</li>
</ul>
<p>
	<br />
...
<h2 style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;padding:2px 20px;border-radius:6px;color:#EBEBEB;font-family:&quot;background:#00BCD4;font-size:20px;line-height:37px;white-space:normal;margin:18px 0px !important;">
	<span style="color:#666666;">功能介绍<span style="display:none;"></span></span>
</h2>
<p>
		...
		<tbody>
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:170px;border:1px solid #D4D1D1;">
					<span style="display:none;"></span><span style="display:none;"></span><span style="display:none;"></span><span style="color:#666666;font-size:16px;"><strong>功能</strong></span><span style="display:none;"></span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:16px;"><strong>描述</strong></span><span style="display:none;"></span><span style="display:none;"></span><span style="display:none;"></span><span style="display:none;"></span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:90px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:16px;"><strong>状态</strong></span><span style="display:none;"></span>
				</td>
			</tr>
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
			...
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">表单数据源自动绑定<span style="display:none;"></span></span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
			...
			<tr>
				<td>
					<span style="font-size:14px;">可配置的后台参数验证<span style="display:none;"></span></span>
				</td>
				<td>
				   直接配置后台模型、参数验证，支持指定参数名验证、指定model字段验证，省去在代码中写if else判断
				</td>
				<td>
									<span style="color:#666666;font-size:14px;">√</span>
				</td>
			...
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">Redis/Memory缓存</span><span style="display:none;"></span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
			...
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">分库分表</span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">分库分表操作</span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
			...
			<tr>
				...
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">后台发布并生成可浏览的静态页面</span><span style="display:none;"></span>
				</td>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;white-space:normal;">√</span><br />
				</td>
			</tr>
			<tr>
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
				...
				<td style="box-sizing:border-box;-webkit-tap-highlight-color:transparent;margin:0px;padding:7px;color:rgba(111, 93, 93, 0.87);font-size:13px;border-collapse:collapse;min-width:60px;border:1px solid #D4D1D1;">
					<span style="color:#666666;font-size:14px;">x</span><span style="display:none;"></span>
				</td>
			</tr>
		</tbody>
	</table>
<span style="background-color:#FFFFFF;"><span style="display:none;"></span><br />
</span>
</p>
