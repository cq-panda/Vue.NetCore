        ...
        data() {
            return {
                ...
                editFormOptions: [[{"dataKey":"pz","title":"品种","required":true,"field":"Variety","type":"select"},
                               ...
                               {"dataKey":"city","title":"报价城市","required":true,"field":"City","type":"selectList"}],
                ...
                searchFormOptions: [[{"dataKey":"pz","title":"品种","field":"Variety","type":"select"},{"dataKey":"age","title":"月龄","field":"Age","type":"select"},{"dataKey":"city","title":"报价城市","field":"City","type":"selectList"}],[{"title":"上报时间","field":"CreateDate","type":"datetime"},{"dataKey":"audit","title":"审核状态","field":"AuditStatus","type":"select"}]],
