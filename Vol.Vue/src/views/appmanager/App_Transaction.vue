    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                extend: extend,
                editFormFileds: {"Name":"","PhoneNo":"","TransactionType":"","CowType":"","Creator":"","CreateDate":""},
                editFormOptions: [[{"columnType":"string","title":"姓名","required":true,"field":"Name"},
                               {"columnType":"string","title":"电话","required":true,"field":"PhoneNo"}],
                              ...
                              [{"columnType":"string","title":"提交人","field":"Creator"},
                               {"columnType":"datetime","title":"提交时间","field":"CreateDate"}]],
                ...
                columns: [{field:'Id',title:'主键ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'PhoneNo',title:'电话',type:'string',width:150,require:true,align:'left'},
