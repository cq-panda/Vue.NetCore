        ...
        data() {
            return {
                ...
                editFormOptions: [[{"dataKey":"pz","title":"品种","required":true,"field":"Variety","colSize":12,"type":"select"}],
                              ...
                              [{"dataKey":"roles","title":"远程搜索(测试)","required":true,"field":"IsTop","colSize":12,"type":"select"}],
                ...
                searchFormOptions: [[{"dataKey":"pz","title":"品种","field":"Variety","type":"drop"},{"dataKey":"age","title":"月龄","field":"AgeRange","type":"dropList"},{"dataKey":"city","title":"城市","field":"City","type":"dropList"}],[{"title":"成交日期","field":"Date","type":"datetime"},{"dataKey":"roles","title":"远程搜索(测试)","field":"IsTop","type":"drop"},{"dataKey":"enable","title":"远程","field":"Enable","type":"selectList"}]],
                columns: [{field:'Id',title:'主键ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'IsTop',title:'远程搜索(测试)',type:'int',bind:{ key:'roles',data:[]},width:90,require:true,align:'left'},
