    ...
    var vueParam = {
        ...
        data() {
            return {
                ...
                editFormOptions: [[{"columnType":"string","dataKey":"pz","title":"品种","required":true,"field":"Variety","colSize":12,"type":"select"}],
                              [{"columnType":"string","dataKey":"age","title":"月龄","required":true,"field":"AgeRange","colSize":12,"type":"select"}],
                              [{"columnType":"string","dataKey":"city","title":"城市","required":true,"field":"City","colSize":12,"type":"select"}],
                              [{"columnType":"decimal","title":"成交均价","required":true,"field":"AvgPrice","colSize":12}],
                              [{"columnType":"datetime","title":"成交日期","required":true,"field":"Date","colSize":12,"type":"date"}],
                              [{"columnType":"int","dataKey":"top","title":"是否推荐价格","required":true,"field":"IsTop","colSize":12,"type":"select"}],
                              [{"columnType":"string","title":"创建人","field":"Creator","disabled":true},
                               {"columnType":"datetime","title":"创建时间","field":"CreateDate","disabled":true}],
                ...
                searchFormOptions: [[{"columnType":"string","dataKey":"pz","title":"品种","field":"Variety","type":"drop"},{"columnType":"string","dataKey":"age","title":"月龄","field":"AgeRange","type":"dropList"},{"columnType":"string","dataKey":"city","title":"城市","field":"City","type":"dropList"}],[{"columnType":"datetime","title":"成交日期","field":"Date","type":"datetime"},{"columnType":"int","dataKey":"top","title":"是否推荐价格","field":"IsTop","type":"drop"},{"columnType":"byte","dataKey":"enable","title":"是否启用","field":"Enable","type":"drop"}]],
