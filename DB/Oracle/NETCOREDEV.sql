...
CREATE TABLE "C##NETCOREDEV"."FORMCOLLECTIONOBJECT" (
  "FORMCOLLECTIONID" RAW(16) VISIBLE NOT NULL,
  "FORMID" RAW(16) VISIBLE,
  "TITLE" NCLOB VISIBLE,
...
CREATE TABLE "C##NETCOREDEV"."FORMDESIGNOPTIONS" (
  "FORMID" RAW(16) VISIBLE NOT NULL,
...
CREATE TABLE "C##NETCOREDEV"."SYS_WORKFLOW" (
  "WORKFLOW_ID" RAW(16) VISIBLE NOT NULL,
...
CREATE TABLE "C##NETCOREDEV"."SYS_WORKFLOWSTEP" (
  "WORKSTEPFLOW_ID" RAW(16) VISIBLE NOT NULL,
  "WORKFLOW_ID" RAW(16) VISIBLE,
...
CREATE TABLE "C##NETCOREDEV"."SYS_WORKFLOWTABLE" (
  "WORKFLOWTABLE_ID" RAW(16) VISIBLE NOT NULL,
  "WORKFLOW_ID" RAW(16) VISIBLE,
...
CREATE TABLE "C##NETCOREDEV"."SYS_WORKFLOWTABLEAUDITLOG" (
  "ID" RAW(16) VISIBLE NOT NULL,
  "WORKFLOWTABLE_ID" RAW(16) VISIBLE,
  "WORKFLOWTABLESTEP_ID" RAW(16) VISIBLE,
  "STEPID" NVARCHAR2(100) VISIBLE,
  "STEPNAME" NVARCHAR2(200) VISIBLE,
...
CREATE TABLE "C##NETCOREDEV"."SYS_WORKFLOWTABLESTEP" (
  "SYS_WORKFLOWTABLESTEP_ID" RAW(16) VISIBLE NOT NULL,
  "WORKFLOWTABLE_ID" RAW(16) VISIBLE NOT NULL,
  "WORKFLOW_ID" RAW(16) VISIBLE,
  "STEPID" NVARCHAR2(100) VISIBLE,
  "STEPNAME" NVARCHAR2(200) VISIBLE,
