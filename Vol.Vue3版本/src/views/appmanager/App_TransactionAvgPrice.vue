 ...
 *业务请在@/extension/system/App_TransactionAvgPrice.js此处编写
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"dataKey":"pz","data":[],"title":"品种","required":true,"field":"Variety","colSize":12,"type":"checkbox"}],
                              ...
                              [{"title":"日期","required":true,"field":"Date","colSize":12,"type":"datetime"}],
            ...
            const searchFormOptions = ref([[{"dataKey":"age","data":[],"title":"月龄","field":"AgeRange","type":"select"},{"dataKey":"pz","data":[],"title":"品种","field":"Variety","type":"select"},{"dataKey":"city","data":[],"title":"城市","field":"City","type":"select"}],[{"title":"日期","field":"Date","type":"datetime"},{"dataKey":"enable","data":[],"title":"测试","field":"IsTop","type":"select"},{"dataKey":"enable","data":[],"title":"远程","field":"Enable","type":"selectList"}]]);
            const columns = ref([{field:'Id',title:'主键ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'AgeRange',title:'月龄',type:'string',bind:{ key:'age',data:[]},width:90,require:true,align:'left',sort:true},
                       ...
                       {field:'Date',title:'日期',type:'datetime',width:90,require:true,align:'left',sort:true},
